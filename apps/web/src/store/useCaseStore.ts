...
const mockCases: Case[] = [
  {
    ...
    description: "Multi-hop structure route flagged via IP-192.168.4.11 and device DEV-FNG-99812. Suspected money mule ring layering funds to clear through shell corporate entities.",
  ...
  },
  {
    ...
    description: "High-frequency transfers under reporting thresholds to destination accounts located in high-risk foreign jurisdictions.",
  ...
  },
  {
    ...
    description: "Dormant account reactivated with transaction size exceeding normal range by 800%.",
