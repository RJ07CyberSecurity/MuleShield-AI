...
export default function ExplorerPage() {
  ...
  useEffect(() => {
    const activeIngestionId = typeof window !== "undefined" ? sessionStorage.getItem("activeIngestionId") : null;
    fetchGraphData(undefined, activeIngestionId || undefined);
  }, [fetchGraphData, pathname]);
